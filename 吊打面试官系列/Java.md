...
***$\color{red}{注意：逻辑或运算符（|）和短路或运算符（||）的差别也是如此。}$***
...
其中Java 面向对象编程三大特性：**$\color{red}{封装、继承、多态}$**
...
![IO-操作方式分类](https://i.loli.net/2021/09/24/m8DpughdlQPcUYN.jpg)

按操作对象分类结构图：

![IO-操作对象分类](https://i.loli.net/2021/09/24/QHYmA8xpsF9SZJV.jpg)
